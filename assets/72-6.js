...
'1.Kf4 Kf6 2.Kg4 Ke6 ' +
'(' +
' {&nbsp;&nbsp;(} 2...Kg6 3.c6 {)} ) 3.Kh5 Kd5 4.Kh6 Ke6 ( {. Безрадостно для чёрных и } 4...Kc4 5.c6 Kxb4 6.c7 Ka3 7.c8=Q b4 8.Qc2 b3 9.Qb1 {.} ) 5.Kxh7 Kf7 { – перед нами позиция, которую мы уже проанализировали. }  *';
  ...
  document.querySelectorAll('.chessBoard__moves *').forEach(function (node) {
    if (!node.children.length && node.textContent) {
      if ((node.className === 'moveNumber') && !node.textContent.startsWith('2...')){
