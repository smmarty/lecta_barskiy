...
'прорваться на шестую горизонталь, а пешка находится у него за спиной, выиграна независимо от очереди хода. Ход белых: <br/>} 1.Kd6 Kd8 2.e6 Ke8 3.e7 Kf7 4.Kd7 {.}  *',
'[Event "?"]' +
'[Site "?"]' +
'[Date "????.??.??"]' +
'[Round "?"]' +
