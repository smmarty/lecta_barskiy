...
'{ Со всеми заботами ферзь не справляется: } ' +
      '(' +
        '{ Белый ферзь охраняет первую горизонталь от смертельного шаха ' +
        'ладьёй или ферзём.<br/>' +
        'Простое отвлечение } ' +
        '1...Qh4 { белым не страшно: }' +
...
' 2.Qxe4 ( { или } 2.Qg1 Qxc6 {.} ) 2...Rf1+ 3.Qe1 Rxe1# *';
  ...
  window.swapMoves([['v6', 'm8']]);
  window.swapMoves([['v6', 'm9']]);
  window.swapMoves([['v6', 'm10']]);
  document.querySelector('#chessBoard__move8 .moveNumber').remove();
})();