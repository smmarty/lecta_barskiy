...
' ' +
'{ &nbsp;К победе ведёт обход с тыла: } 1.Ke8!' +
  '(' +
    '{ На прямолинейное } 1.Ke6 { находится тонкая защита } ' +
    '1...Ka6! 2.Kd7 Kb7! 3.Kd6 Kb6 4.d5 cxd5 5.Kxd5 Kb7 6.Kc5 Kc7 7.Kxb5 Kb7! ' +
    '{ с&nbsp;ничьей. } ' +
  ') ' +
'1...Ka7 ' +
    '(' +
      '{ &nbsp;(не выручают и } 1...Kc7 2.Ke7 ' +
    ') ' +
    '(' +
      '{ или } 1...Kb7 2.Kd7 {)}' +
    ') ' +
...
'3.Kd8! Kb7 4.Kd7 Kb6 5.Kc8 { с победой. }  *';
  ...
  window.swapMoves([['v28', 'm32']]);
  window.swapMoves([['v28', 'm33']]);
  window.swapMoves([['v28', 'm34']]);
  window.swapMoves([['v28', 'm35']]);
  window.swapMoves([['v28', 'm36']]);
})();