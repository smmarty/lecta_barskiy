...
'чёрных, а поле превращения охраняет ладья. Но этого охранника можно обезвредить:<br/> } 1.Qxc8+! Kxc8 2.f8=Q+ {. В результате комбинации с жертвой ферзя белые остались ' +
'с лишней ладьёй. }  *';
