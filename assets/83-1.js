...
'2...Rg8 3.Qe5+ Rhg7 { (чёрные пробуют закрыться другой ладьёй) } 4.Qh5+ Rh7 5.Qe5+ { , и&nbsp;выясняется, что чёрному королю не спрятаться от вечного преследования. Как только позиция после 1.♕e5+ повторится три раза, можно зафиксировать ничью. }  *';
