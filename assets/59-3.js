...
' ' +
'{ Сильная проходная пешка, поддержанная ферзём и ладьёй, помогает белым добиться решающего преимущества. } 1.d7+ Kb8 ( { На } 1...Qxd7 { следует } 2.Rf8+ ) 2.Rf8! { Чтобы ' +
'расчистить дорогу проходной, белые жертвуют ладью. } 2...Qxf8 3.d8=Q+ { , и мат следующим ходом. }  *';
