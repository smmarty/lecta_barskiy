...
' ' +
'{ Казалось бы, белым несложно добиться ничьей, ведь достаточно отдать коня за проходную. Но у чёрных находится эффектная комбинация на тему <i>прорыва</i>: } 1...Ng2+! 2.Nxg2 { (иначе чёрные сами заберут коня) } 2...h3 3.Kf2 h2 { Конь и король совсем рядом с проходной, но только провожают её ' +
