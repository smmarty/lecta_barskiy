...
' ' +
'{ Пешки, расположенные на вертикалях «а» и «h», называются крайними пешками &nbsp;(они идут по краю доски). Их не удаётся провести в ферзи, если на пути встаёт неприятельский король. <br />Допустим, ход белых. После } 1.Kb6 Kb8 2.a6 Ka8 3.a7 { получается пат: у чёрного короля нет ещё одного поля на седьмой горизонтали, потому что доска закончилась. }  *';
