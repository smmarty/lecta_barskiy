...
' ' +
'1.e4 e5 2.Nf3 Nc6 3.Bc4 Bc5 4.c3 Nf6 5.d4 exd4 6.cxd4 {<br />} Bb4+ ' +
    '(' +
...
'{<br/>}12...Ne7 ' +
      '(' +
        '{. Остроумный контрудар } 12...Nxd4 {(с&nbsp;идеей} 13.Nxd4' +
        '(' +
          ' {не спасает из-за промежуточного шаха} 13.Qa3+ {, и чёрные теряют ферзя.}' +
        ')' +
        '13...Qxg5 {)}' +
      ')' +
...
'16.Bg8! { белые добиваются решающего материального перевеса. }  *';
  ...
  window.loadPlayer({
    ...
    player: {
      pgn: pgn,
      title: 'Диаграммы 91-1, 91-2, 91-3',
      pawn_notation: 'short'
    }
  });
  ...
  window.swapMoves([['v15', 'm21']]);
  window.swapMoves([['v45', 'm46']]);
  document.querySelector('#chessBoard__move46 .moveNumber').remove();
})();