...
' ' +
'{ Надо подвести короля к пешкам: <br/>} ' +
'1.Kh6 {.}' +
  '( ' +
    '{<br/> Немедленный рывок пешки в ферзи ничего не даёт: } ' +
    '1.c6? Ke6 2.Kg6 Kd6 3.Kf6 Kxc6 4.Ke6 Kc7 5.Kd5 Kb7 6.Kc5 Kc7 7.Kxb5 Kb7! ' +
    '{ с ничьей. } ' +
  ') ' +
'{<br/>}1...Kf6 { – чёрный король отталкивает оппонента плечом } ' +
'2.Kh5 Kf5 3.Kh4! Kf6 ' +
  '(' +
  ...
  ') ' +
'4.Kg4 Ke6' +
  '( {(} 4...Kg6 5.c6 {) – эту позицию мы ранее разобрали. })  *';
